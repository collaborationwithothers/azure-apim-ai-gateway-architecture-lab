# Scenario: Baseline Foundry Proxy

## 1. Business problem

Enterprise teams need basic API facade, backend abstraction, named values, and the risk of direct model access. Without a gateway pattern, each client implements these controls differently and backend governance becomes inconsistent.
...
APIM adds latency and cost, but centralizes governance, security, observability, and operational control.
