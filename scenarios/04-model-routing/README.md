...
Enterprise teams need routing by request type, tenant tier, model capability, region, cost profile, and degraded-mode fallback. Without a gateway pattern, each client implements these controls differently and backend governance becomes inconsistent.
