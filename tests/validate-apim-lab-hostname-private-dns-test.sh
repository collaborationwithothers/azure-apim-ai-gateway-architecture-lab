...
grep -q "az resource show" "$workflow"
grep -q "Microsoft.ApiManagement/service" "$workflow"
grep -q "api-version 2024-05-01" "$workflow"
grep -q "properties.privateIPAddresses\\[0\\]" "$workflow"
